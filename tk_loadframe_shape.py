...
class tk_loadframe_shape(ttk.Frame):
    ...
    def create_another_widgets(self):
        ...
        self.loadone_button=ttk.Button(self,textvariable=self.master.transtatedict["loadshape"],command=self.load_shape)
        self.loadone_button.grid(row=13,column=14,columnspan=3, padx=2, pady=2, sticky=tk.NSEW)
        self.deletesel_button=ttk.Button(self,textvariable=self.master.transtatedict["deletesel"],command=self.del_selected)
        self.deletesel_button.grid(row=13,column=4,columnspan=3, padx=2, pady=2, sticky=tk.NSEW)
        ...
        self.cancel_button.grid(row=15,column=8,columnspan=5, padx=2, pady=2, sticky=tk.NSEW)
        ...
        #self.shapebutton=ttk.Button(self,textvariable=self.master.transtatedict["all6startmainbutton"],command=partial(self.master.atmospheric_calc_start,self))
        #self.shapebutton.grid(row=10,column=20,columnspan=2, padx=2, pady=2, sticky=tk.NSEW)
